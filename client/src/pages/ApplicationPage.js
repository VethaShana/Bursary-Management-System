					...
					<Grid item xs={12} sm={6} md={4}>
						<FormControl size='small' variant='outlined' fullWidth>
							...
							<Select
								...
								value={GSDivisions[0].division}
								label='Grama-Sevaka Division'
							>
								{GSDivisions.map((GSDivision, idx) => (
									<MenuItem value={GSDivision.division} key={idx}>
										{GSDivision.division}
									</MenuItem>
								))}
							</Select>
					...
					<Grid item xs={12} sm={6} md={4}>
						<FormControl size='small' variant='outlined' fullWidth>
							...
							<Select
								...
								value={GSDivisions[0].divisionNo}
								label='Grama-Sevaka Division No.'
							>
								{GSDivisions.map((GSDivision, idx) => (
									<MenuItem value={GSDivision.divisionNo} key={idx}>
										{GSDivision.divisionNo}
									</MenuItem>
								))}
							</Select>
						</FormControl>
