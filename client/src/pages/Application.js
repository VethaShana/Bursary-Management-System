...
const validationSchema = yup.object({
	...
	indexNo: yup
		...
		.required('Index No. is required, If not provided contact welfare dept.'),
	nic: yup
		.string()
		.trim()
		.matches(
	...
	title: yup.string().oneOf(titles, 'Invalid title').required('Select a title'),
	...
	spouse: yup.object().when('married', (married, schema) =>
		schema.shape({
			name: married ? yup.string().required('Name is required') : yup.string(),
	...
	father: yup.object().shape({
		...
		age: yup.number().when('living', {
			...
			then: yup
				...
				.max(123, 'World record for oldest person is 122 years and 164 days :)')
							...
							<Form>
								<Grid container spacing={2} style={{ padding: '32px 8px' }}>
									<Grid item xs={12} md={3}>
										...
										<Typography variant='body2' color='initial'>
											If Index No. is not provided, please contact relevant
											department before filling the application
										</Typography>
									</Grid>
								...
								<Grid container spacing={2} style={{ padding: '32px 8px' }}>
									<Grid item xs={12} md={3}>
										...
										<Typography variant='body2' color='initial'>
											No Fields should be left blank. State your permanent
											Address here.
										</Typography>
									</Grid>
									<Grid container item spacing={2} xs={12} md={9}>
								...
								<Grid container spacing={2} style={{ padding: '32px 8px' }}>
									<Grid item xs={12} md={3}>
										...
										<Typography variant='body2' color='initial'>
											Provide your Employment details, If you are employed by
								...
								<Grid container spacing={2} style={{ padding: '32px 8px' }}>
									<Grid item xs={12} md={3}>
										...
										<Typography variant='body2' color='initial'>
											Provide your Marriage details, If you are married by
											selecting the checkbox
										</Typography>
									</Grid>
									<Grid container item spacing={2} xs={12} md={9}>
								...
								<Grid
									container
									spacing={2}
									style={{ padding: '32px 8px', paddingBottom: '0' }}
								>
									<Grid item xs={12} md={3}>
										<Typography variant='h6' color='initial' gutterBottom>
										...
										<Typography variant='body2' color='initial' gutterBottom>
											No Fields should be left blank. State whether particular
											individual is living or not using the checkbox.
										</Typography>
										<Alert
											severity='warning'
											variant='outlined'
										...
										>
											If the particular individual is not living original death
									...
									<Grid container item spacing={2} xs={12} md={9}>
										...
										<Grid item xs={12}>
											...
											<Typography variant='caption' color='textSecondary'>
												State annual income of particulars from 01
												<sup>st</sup> of January to 31<sup>st</sup> December{' '}
										...
										<Grid item xs={12}>
											...
											<Typography variant='caption' color='textSecondary'>
												This section should be filled by orphans or clergy or
												any other applicant who under the custody of a legal
												guardian
											</Typography>
										</Grid>
								...
								<Grid
									...
									xs={12}
									justify='flex-end'
									style={{ padding: '0 16px', paddingTop: '32px' }}
								>
									<Button
